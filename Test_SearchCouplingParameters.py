# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 21:38:05 2024
...
while Pmax <= 0 or Pmin >= 0:
    ...
    DDME_parameters1 = np.hstack((m_range, gamma_range))
    DDME_parameters2 = np.hstack((coupling_parameters, coupling_rho))
    DDME_parameters  = np.hstack((DDME_parameters1, DDME_parameters2)) 
